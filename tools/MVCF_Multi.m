function [U_final, V_final, nIter_final, objhistory_final] = MVCF_Multi(K, k, W, options, U, V, lambda)
%
% where
%   X
% Notation:
...
%
% References:
% [1] K. Zhan, J. Shi, J. Wang, H. Wang, and Y. Xie
...
%   Modified by Kun Zhan, Haibo Wang et al.
%
...
%     tmp_T = cputime;
    ...
    while(maxErr > differror)
        ...
        clear KU KpU KnU UKpU UKnU VUKpU VUKnU
       % ========================== update U ========================
        KV=K*V;
        VV=V'*V;
        UVV=U*VV;
