function [U_final, V_final, nIter_final, objhistory_final] = MVCF(X, k, W, options, U, V, lambda)
%
% where
%   X
% Notation:
...
switch lower(options.Optimization)
    case {lower('Multiplicative')}
        [U_final, V_final, nIter_final,objhistory_final] = MVCF_Multi(K, k, W, options, U, V, lambda);
    otherwise
